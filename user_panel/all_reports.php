...
<CENTER><br>
    <h2>ALL TRANSACTIONS REPORT TABLE</h2>
    <div>
    ...
    <div class="table-container">
        <table id="myTable">
            ...
            <tbody>
                ...
                // Assuming $con, $user_id, $startIndex, $rowsPerPage, and $si_no are defined earlier in your code
           ...
           ORDER BY date DESC 
           LIMIT $startIndex, $rowsPerPage"; // SQL query with pagination and ordering
...
<script>
    ...
    function searchByDate() {
        ...
        const url = `all_search.php?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}`;
    ...
    function fetchData(page) {
        fetch(`all_table.php?page=${page}`) // Adjust the URL to your PHP script
            .then(response => response.text())
            .then(data => {
