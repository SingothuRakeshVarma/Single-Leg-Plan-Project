...
<table id="myTable">
    ...
    <tbody>
        ...
        if (isset($_GET['search'])) {
            ...
            $sql = "SELECT COUNT(*) AS total_count FROM user_data WHERE referalid = '$user_id' AND user_name LIKE '%$search%' OR user_id LIKE '%$search%'";
            ...
            $query = "SELECT * FROM `user_data` WHERE referalid = '$user_id' AND user_name LIKE '%$search%' OR user_id LIKE '%$search%' LIMIT $offset, $rowsPerPage"; // SQL query with pagination and search
...
<script>
    ...
    function fetchData(page) {
        fetch(`referral_table_search.php?page=${page}`) // Adjust the URL to your PHP script
