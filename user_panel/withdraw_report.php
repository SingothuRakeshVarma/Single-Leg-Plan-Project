    ...
    <div class="table-container">
        <table id="myTable">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM `withdraws` WHERE user_id = '$user_id' order by wdate desc LIMIT $startIndex, $rowsPerPage"; // SQL query with pagination
    ...
    <div class="pagination">
        ...
        <script>
            ...
            function searchByDate() {
                ...
                const url = `withdraw_search.php?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}`;
            ...
            document.getElementById('dateSearchButton').addEventListener('click', searchByDate);
             ...
             function fetchData(page) {
                fetch(`withdraw_table.php?page=${page}`) // Adjust the URL to your PHP script
                    .then(response => response.text())
                    .then(data => {
