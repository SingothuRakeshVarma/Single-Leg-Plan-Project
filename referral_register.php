        ...
        <div class="login_container">
            <div>
                <center>
                    ...
                    <form action="loginpage.php" id="signInForm" method="post" style="display: none;" >
                    ...
                    <form class="Register-details" id="signUpForm" style="display: block;" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reffid" class="prof_text" style="width: 60%;" value="<?php echo $referalid; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="fullName" class="prof_label">Reffral Name:</label><br>
                            <input type="text" class="prof_text" name="referral_name" value="<?php echo $reffname; ?>" style="width: 60%;" readonly>
                        </div><br>
