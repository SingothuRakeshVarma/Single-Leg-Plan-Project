...
$query = "SELECT * FROM `product_delivery` WHERE status = 'Dispatch_Pending'";
...
<th class='hedlines red1'><center>Status</center></th>
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td class='hedline green1'><a class='acclink' href='delivery_report_update.php?id=" . $id .  " && user_id=" . $user_id . " && product_name=" . $product_name . "'>Edit</a>  <a class='rejlink' href='delivery_report_delect.php?id=" . $id .  " && user_id=" . $user_id . " && product_name=" . $product_name . "'>Delect</a></td>";
