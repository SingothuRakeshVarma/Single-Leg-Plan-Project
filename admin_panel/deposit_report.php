    ...
    <tbody>
        ...
        if (isset($_GET['search'])) {
            ...
            if ($start_date !== '' && $end_date !== '') {
                ...
                $countQuery = "SELECT COUNT(*) AS total_count FROM deposit WHERE  ddate BETWEEN ? AND ?";
                ...
                $sql = "SELECT * FROM deposit WHERE  ddate BETWEEN ? AND ? ORDER BY ddate desc LIMIT ?, ?";
            ...
            $query = "SELECT * FROM `deposit` ORDER BY ddate desc  LIMIT $startIndex, $rowsPerPage"; // SQL query with pagination
