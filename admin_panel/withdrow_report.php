...
<CENTER><br>
            ...
            <tbody>
                ...
                if (isset($_GET['search'])) {
                    ...
                    if ($start_date !== '' && $end_date !== '') {
                        ...
                        $countQuery = "SELECT COUNT(*) AS total_count FROM withdraws WHERE wdate BETWEEN ? AND ?";
                        ...
                        $sql = "SELECT * FROM withdraws WHERE wdate BETWEEN ? AND ? ORDER BY wdate LIMIT ?, ?";
                        ...
                        $query = "SELECT * FROM `withdraws` LIMIT $startIndex, $rowsPerPage"; // SQL query with pagination
    ...
    <script>
        ...
        function fetchData(page) {
            fetch(`withdrow_next_page.php?page=${page}`) // Adjust the URL to your PHP script
