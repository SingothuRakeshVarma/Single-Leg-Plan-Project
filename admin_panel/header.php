...
<body>
    <section>
        <div class="container_head">
            ...
            <div>
                <a href="./log_out.php"> <img class="profile_imag " src="./images/desktop-wallpaper-baby-groot-1440p-resolution-artist-and-background.jpg""
                        alt=" profil_img">
    ...
    <section>
        <div class="fixed-bottom-left">
            ...
            <p style="position: relative; left: -15px; top: -12px;" class="blinking-icon">Messages</p>
            <?php
            $qurey = "SELECT COUNT(user_id) as mgcount FROM `complaint_box` WHERE `status` = 'Pending'";
