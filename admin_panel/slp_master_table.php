...
<table id="myTable">
  ...
  $sql = "SELECT COUNT(*) AS total_count FROM slp_master";
...
while ($row = $result->fetch_assoc()) {
  ...
  echo "<td class='hedlines green1'>" . $floor_name  . "</td>";
    echo "<td class='hedlines green1'>" . $row["add_mumbers"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["mumber_share"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["no_of_days"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["total_income"] . "</td>";
    echo "<td class='hedline green1'><a class='acclink' href='slp_master_update.php?id=" . $floor_name .  "'>Edit</a>  <a class='rejlink' href='slp_master_delect.php?id=" . $floor_name .  "'>Delect</a></td>";
    echo "</tr>";
