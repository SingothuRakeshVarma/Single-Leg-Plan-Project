...
<CENTER><h2>LEVEL INCOME MASTER</h2></CENTER>
...
<table id="myTable">
  ...
  $sql = "SELECT COUNT(*) AS total_count FROM floor_income_master";
...
$query = "SELECT * FROM `floor_income_master`";
...
while ($row = $result->fetch_assoc()) {
  ...
  echo "<td class='hedlines green1'>" . $floor_name  . "</td>";
    echo "<td class='hedlines green1'>" . $row["level_1_income"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["level_2_income"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["floor_value"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["drb"] . "</td>";
    echo "<td class='hedlines green1'>" . $row["total_floor_income"] . "</td>";
    echo "<td class='hedline green1'><a class='acclink' href='floor_income_master_update.php?id=" . $floor_name .  "'>Edit</a>  <a class='rejlink' href='floor_income_master_delect.php?id=" . $floor_name .  "'>Delect</a></td>";
    echo "</tr>";
    $si_no++; // Increment the counter for the next row
