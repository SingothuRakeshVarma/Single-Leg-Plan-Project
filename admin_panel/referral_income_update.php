...
if (isset($_GET['id'])) {
  ...
  $query = "SELECT * FROM `referal_income` WHERE product_id = ?";
...
if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE `referal_income` 
                     SET type = ?, 
                         category = ?, 
                         sub_category = ?, 
                         packagename = ?, 
    ...
    if ($stmt->execute()) {
      echo '<script>alert("Level Income data Update successfully!");window.location.href = "referral_income_table.php";</script>';
    } else {
  ...
  <div class="page-container">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="check-details" method="post">
      ...
      <div class="check-items">
        ...
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_value']; ?>" name="self" placeholder="Enter Value">
      </div>

      <div class="check-items">
        <label for="name" class="active-id">Level-1</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_1']; ?>" name="level_1" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-2</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_2']; ?>" name="level_2" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-3</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_3']; ?>" name="level_3" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-4</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_4']; ?>" name="level_4" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-5</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_5']; ?>" name="level_5" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-6</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_6']; ?>" name="level_6" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-7</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_7']; ?>" name="level_7" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-8</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_8']; ?>" name="level_8" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-9</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_9']; ?>" name="level_9" placeholder="Enter Value">
      </div>
      <div class="check-items">
        <label for="name" class="active-id">Level-10</label><BR>
        <input type="text" class="txt-user-id" value="<?php echo $row['referral_10']; ?>" name="level_10" placeholder="Enter Value">
      </div>
